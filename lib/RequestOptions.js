/** @typedef {import('./RequestTypes').HostRule} HostRule */
...
export class RequestOptions {
  ...
  constructor(opts = {}) {
     ...
     * @default *\/*
     */
    this.defaulAccept = opts.defaulAccept;
    /**
  ...
  get validOptions() {
    return {
      ...
      // compatybility with ARC config object.
  ...
  _validateCertificate(opts) {
    ...
    if (!opts.clientCertificate.type) {
      this.validationWarnings.push(
        'The certificate has no type. It will be ignored.'
      );
      try {
    ...
    if (!opts.clientCertificate.cert) {
      this.validationWarnings.push(
        'The certificate has no data. It will be ignored.'
      );
      try {
        delete opts.clientCertificate;
      } catch (_) {
