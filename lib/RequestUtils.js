import { URL } from 'url';
/** @typedef {import('./ArcHeaders.js').ArcHeaders} ArcHeaders */
/**
...
export class RequestUtils {
   ...
   *
   * @param {number|string} port Existing information abour port.
   ...
   * @param {object[]|Set<Object>} redirects List of response objects
