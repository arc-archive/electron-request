...
export class BaseRequest extends EventEmitter {
   ...
   * - cert {Array<Certificate>|Certificate} The certificate to use. Required.
   * - key {Array<Certificate>|Certificate} Key for `pem` certificate. Optional.
   *
   * @param {Object} cert List of certificate configurations.
   * @param {Object} options Request options. Cert agent options are
