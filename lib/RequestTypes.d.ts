 ...
 * This object has been repraced in Q1 2020 wit OAS3 support release.
 */
...
export declare interface ArcCertificate {
  /**
   * Type of ther certificate, either `p12` or `pem`
   */
  type: string;
  /**
   * The certificate to use
...
export declare interface ResponsePublishOptions {
  ...
  /**
   * An error object when the response is errored.
   */
  error?: Error;
}
